...
<section class="section">
    ...
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a class="text-info" href="{{ route('semester_VIII.materi') }}">Materi</a></div>
        </div>
    </div>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card card-statistic-2 card-success">
                ...
                <div class="card-stats">
                    ...
                    <div class="container">
                                <p class="ml-2">
                                    <a href="{{ route('semester_VIII.materi.mata_kuliah', $mata_kuliah->id) }}" class="text-dark">
                        ...
                        @if($materis->file_materi)
                            ...
                            <div class="d-flex justify-content-center mt-1">
                                <a href="/semester_VIII/materi/{{$mata_kuliah->id}}/download/{{$materis->id}}" class="btn btn-success btn-sm">
                ...
                <div class="card-wrap">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="/semester_VIII/materi/{{$mata_kuliah->id}}/update/{{$materis->id}}" class="btn btn-info btn-sm mr-2"><i class="fas fa-edit"></i> Update</a>
...
<div class="modal fade" id="deleteMateri" tabindex="-1" aria-labelledby="deleteMateriLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="/semester_VIII/materi/{{$mata_kuliah->id}}/delete/{{$materis->id}}" method="post"> 
                @method('delete')
                @csrf
