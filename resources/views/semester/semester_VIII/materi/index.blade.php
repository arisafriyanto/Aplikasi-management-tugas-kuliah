...
<section class="section">
    ...
    <div class="row">
        ...
        @foreach ($semesters as $semester)
            ...
            <a href="{{ route('semester_VIII.materi.mata_kuliah', $semester->id) }}" class="text-success">
                <div class="col-lg-4 col-md-4 col-sm-12">
                    ...
                    <div class="card-wrap">
                        ...
                        <a href="{{ route('semester_VIII.materi.mata_kuliah', $semester->id) }}"><h4>Total Materi</h4></a>
                        </div>
                        <div class="card-body">
