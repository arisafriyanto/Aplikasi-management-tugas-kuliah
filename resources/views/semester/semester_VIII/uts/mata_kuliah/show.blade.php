...
<section class="section">
    ...
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a class="text-info" href="{{ route('semester_VIII.uts') }}">Uts</a></div>
        </div>
    </div>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card card-statistic-2 card-success">
                ...
                <div class="card-stats">
                    ...
                    <div class="container">
                                <p class="ml-2">
                                    <a href="{{ route('semester_VIII.uts.mata_kuliah', $mata_kuliah->id) }}" class="text-dark">
                        ...
                        @if($uts->file_uts)
                            ...
                            <div class="d-flex justify-content-center mt-1">
                                <a href="/semester_VIII/uts/{{$mata_kuliah->id}}/download/{{$uts->id}}" class="btn btn-success btn-sm">
                ...
                <div class="card-wrap">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="/semester_VIII/uts/{{$mata_kuliah->id}}/update/{{$uts->id}}" class="btn btn-info btn-sm mr-1"><i class="fas fa-edit"></i> Update</a>


                        <a href="/semester_VIII/uts/{{$mata_kuliah->id}}/answer/{{$uts->id}}" class="btn btn-warning btn-sm mr-1"><i class="fas fa-upload"></i> Answer</a>
...
<div class="modal fade" id="deleteUts" tabindex="-1" aria-labelledby="deleteUtsLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="/semester_VIII/uts/{{$mata_kuliah->id}}/delete/{{$uts->id}}" method="post"> 
                @method('delete')
                @csrf
