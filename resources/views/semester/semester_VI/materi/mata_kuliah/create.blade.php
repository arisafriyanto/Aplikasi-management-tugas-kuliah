...
<section class="section">
    ...
    <div class="section-body">                
        <div class="card">
            <form method="POST" action="{{ route('semester_VI.materi.mata_kuliah.store', $mata_kuliah->id) }}" novalidate enctype="multipart/form-data">
                @csrf
                ...
                <div class="card-footer text-left">
                    <a href="{{ route('semester_VI.materi.mata_kuliah', $mata_kuliah->id) }}" class="btn btn-warning"><i class="fas fa-backward"></i> Back</a>
