...
<section class="section">
    ...
    <div class="section-body">                
        <div class="card">
            <form method="POST" action="{{ route('semester_VI.store') }}" novalidate>
                @csrf
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-12 col-md-12 col-lg-12">
                            ...
                            <input type="text" class="form-control" name="semester" value="Semester VI" readonly>
                ...
                <div class="card-footer text-left">
                    <a href="/semester_VI" class="btn btn-warning"><i class="fas fa-backward"></i> Back</a>
