...
<section class="section">
    ...
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a class="text-info" href="{{ route('semester_III.tugas') }}">Tugas</a></div>
        </div>
    </div>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card card-statistic-2 card-success">
                ...
                <div class="card-stats">
                    ...
                    <div class="container">
                                <p class="ml-2">
                                    <a href="{{ route('semester_III.tugas.mata_kuliah', $mata_kuliah->id) }}" class="text-dark">
                        ...
                        @if($tugas->file_tugas)
                            ...
                            <div class="d-flex justify-content-center mt-1">
                                <a href="/semester_III/tugas/{{$mata_kuliah->id}}/download/{{$tugas->id}}" class="btn btn-success btn-sm">
                ...
                <div class="card-wrap">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="/semester_III/tugas/{{$mata_kuliah->id}}/update/{{$tugas->id}}" class="btn btn-info btn-sm mr-1"><i class="fas fa-edit"></i> Update</a>


                        <a href="/semester_III/tugas/{{$mata_kuliah->id}}/answer/{{$tugas->id}}" class="btn btn-warning btn-sm mr-1"><i class="fas fa-upload"></i> Answer</a>
...
<div class="modal fade" id="deleteTugas" tabindex="-1" aria-labelledby="deleteTugasLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="/semester_III/tugas/{{$mata_kuliah->id}}/delete/{{$tugas->id}}" method="post"> 
                @method('delete')
                @csrf
