...
<section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">Semester III</div>
      </div>
    </div>
    ...
    <div class="section-body">
        ...
        <div class="d-flex justify-content-between">
            ...
            <div class="">
                <a href="{{ route('semester_III.create') }}" class="btn mr-2 mb-2 btn-info">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="{{ route('semester_III.materi') }}">Materi</a>
                    <a class="dropdown-item" href="{{ route('semester_III.tugas') }}">Tugas</a>
                    <a class="dropdown-item" href="{{ route('semester_III.uts') }}">UTS</a>
                    <a class="dropdown-item" href="{{ route('semester_III.uas') }}">UAS</a>
                </div>
            </div>
    </div>
                        ...
                        <tbody>
                            ...
                            @can('views', $semester)
                                ...
                                <tr style="text-align: center;">
                                    ...
                                    <td>
                                        <a href="/semester_III/{{ $semester->id }}" class="btn btn-success  mb-2">
...
<div class="modal fade" id="deleteModal" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="form-delete" method="post" action="{{ route('semester_III.delete') }}">
                @csrf
                @method('delete')
