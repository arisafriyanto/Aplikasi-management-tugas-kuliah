...
<section class="section">
    ...
    <a href="/semester_I/tugas/{{$mata_kuliah->id}}/show/{{$task->id}}" class="text-success">
        <div class="col-lg-4 col-md-4 col-sm-12">
            ...
            <div class="card-wrap">
                ...
                <a href="/semester_I/tugas/{{$mata_kuliah->id}}/show/{{$task->id}}">
    ...
    <a href="/semester_I/tugas/{{$mata_kuliah->id}}/show/{{$task->id}}" class="text-danger">
        <div class="col-lg-4 col-md-4 col-sm-12">
    ...
    <div class="">
        <a href="{{ route('semester_I.tugas.mata_kuliah.create', $mata_kuliah->id) }}" class="btn mr-2 mb-2 btn-info">
