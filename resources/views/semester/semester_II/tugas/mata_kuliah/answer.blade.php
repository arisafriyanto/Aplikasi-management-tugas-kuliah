...
@include('alert')
    ...
    <div class="section-body">                
        <div class="card">
                    ...
                    <p class="ml-2">
                        ...
                        @if($tugas->file_answer)
                            ...
                            <div class="d-flex justify-content-center mt-1">
                                <a href="/semester_II/tugas/{{$mata_kuliah->id}}/download_answer/{{$tugas->id}}" class="btn btn-success btn-sm">
            ...
            <form method="POST" 
            action="/semester_II/tugas/{{$mata_kuliah->id}}/answer_tugas/{{$tugas->id}}" novalidate enctype="multipart/form-data">
                @csrf
                @method('patch')
                ...
                <div class="card-footer text-left">
                    <a href="/semester_II/tugas/{{ $mata_kuliah->id }}/show/{{ $tugas->id }}" class="btn btn-warning"><i class="fas fa-backward"></i> Back</a>
