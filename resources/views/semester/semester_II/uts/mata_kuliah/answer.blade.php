...
@include('alert')
    ...
    <div class="section-body">                
        <div class="card">
                    ...
                    <p class="ml-2">
                        ...
                        @if($uts->file_answer)
                            ...
                            <div class="d-flex justify-content-center mt-1">
                                <a href="/semester_II/uts/{{$mata_kuliah->id}}/download_answer/{{$uts->id}}" class="btn btn-success btn-sm">
            ...
            <form method="POST" 
            action="/semester_II/uts/{{$mata_kuliah->id}}/answer_uts/{{$uts->id}}" novalidate enctype="multipart/form-data">
                @csrf
                @method('patch')
