...
<section class="section">
    ...
    <div class="section-body">                
        <div class="card">
            ...
            <form method="POST" action="/semester_VII/materi/{{$mata_kuliah->id}}/edit/{{$materis->id}}" novalidate enctype="multipart/form-data">
                @csrf
                @method('patch')
                ...
                <div class="card-footer text-left">
                    <a href="/semester_VII/materi/{{ $mata_kuliah->id }}/show/{{ $materis->id }}" class="btn btn-warning"><i class="fas fa-backward"></i> Back</a>
