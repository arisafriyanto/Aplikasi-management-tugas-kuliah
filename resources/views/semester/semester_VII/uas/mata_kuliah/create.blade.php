...
<section class="section">
    <div class="section-header">
      <h1>Tambah Uas {{ $mata_kuliah->mata_kuliah }}</h1>
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a class="text-info" href="{{ route('semester_VII.uas') }}">Uas</a></div>
    ...
    <div class="section-body">                
        <div class="card">
            <form method="POST" action="{{ route('semester_VII.uas.mata_kuliah.store', $mata_kuliah->id) }}" novalidate enctype="multipart/form-data">
                @csrf
                
                <div class="card-header">
                    <h4 class="text-info"><i class="fas fa-plus"></i> Tambah Uas</h4>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-12 col-md-12 col-lg-12">
                            ...
                            <input type="text" class="form-control @error('uas') is-invalid @enderror" name="uas" value="{{ old('uas') }}" required="" autofocus>
                        ...
                        <div class="form-group col-12 col-md-12 col-lg-12">
                            ...
                            <textarea name="keterangan_uas" class="form-control @error('keterangan_uas') is-invalid @enderror" required="">{{ old('keterangan_uas') }}</textarea>
                ...
                <div class="card-footer text-left">
                    <a href="{{ route('semester_VII.uas.mata_kuliah', $mata_kuliah->id) }}" class="btn btn-warning"><i class="fas fa-backward"></i> Back</a>
