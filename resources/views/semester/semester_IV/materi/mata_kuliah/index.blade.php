...
<section class="section">
    ...
    <a href="/semester_IV/materi/{{$mata_kuliah->id}}/show/{{$m->id}}" class="text-success">
        <div class="col-lg-4 col-md-4 col-sm-12">
            ...
            <div class="card-wrap">
                ...
                <a href="/semester_IV/materi/{{$mata_kuliah->id}}/show/{{$m->id}}"><h4>Date : {{ $m->created_at->format('d M Y') }}</h4></a>
                </div>
    ...
    <div class="">
        <a href="{{ route('semester_IV.materi.mata_kuliah.create', $mata_kuliah->id) }}" class="btn mr-2 mb-2 btn-info">
