        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card card-statistic-2 card-success">
                ...
                <div class="card-stats">
                    ...
                    <div class="container">
                                <p class="ml-2">
                                    <a href="{{ route('semester_V.uas.mata_kuliah', $mata_kuliah->id) }}" class="text-dark">
                        ...
                        @if($uas->file_uas)
                            ...
                            <div class="d-flex justify-content-center mt-1">
                                <a href="/semester_V/uas/{{$mata_kuliah->id}}/download/{{$uas->id}}" class="btn btn-success btn-sm">
                ...
                <div class="card-wrap">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="/semester_V/uas/{{$mata_kuliah->id}}/update/{{$uas->id}}" class="btn btn-info btn-sm mr-1"><i class="fas fa-edit"></i> Update</a>


                        <a href="/semester_V/uas/{{$mata_kuliah->id}}/answer/{{$uas->id}}" class="btn btn-warning btn-sm mr-1"><i class="fas fa-upload"></i> Answer</a>
...
<div class="modal fade" id="deleteUas" tabindex="-1" aria-labelledby="deleteUasLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="/semester_V/uas/{{$mata_kuliah->id}}/delete/{{$uas->id}}" method="post"> 
                @method('delete')
                @csrf
